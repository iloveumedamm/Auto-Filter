...
# Bot Admins
ADMINS = environ.get('ADMINS', '6597445442') #apni tg id daalo
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001708559566 -1001932915263').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001953206885') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '0') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://benoj60137:TmFajHsZTzwZjpNo@cluster0.a5feauq.mongodb.net/?retryWrites=true&w=majority") #mongo db url
...
PM_SEARCH = is_enabled('PM_SEARCH', 0) #switch True or False for searching results in bot pm😃
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001953206885") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://slslslslsllsll-e2fd6f5cf1a6.herokuapp.com/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
